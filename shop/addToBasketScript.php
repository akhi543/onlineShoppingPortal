<?php
	...
	if($_SESSION['user_name']!=null) {
		...
		if($quant > $stock) {
			...
			mysqli_query($con, "update basket set numprods = $numprods") or die("q3 error!");
			mysqli_query($con, "update basket set totalcost = $totalcost") or die("q4 error!");

			$r5 = mysqli_query($con, "insert into basketprods(bid,pid,quantity) values($bid, $pid, $quant)") or die("q5 error!");
			echo "Added :)";
		}
	}
	else {
